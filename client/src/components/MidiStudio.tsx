...
import { Music, Play, Edit, Layers } from 'lucide-react';
...
export const MidiStudio: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">MIDI Studio</h1>
        <p className="text-white/60">
          Explore, play, and compose with your comprehensive MIDI collection
        </p>
      </div>
