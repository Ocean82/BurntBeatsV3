...
class MidiService {
    ...
    generatorScript = './music Gen extra/Main.py'; // Main generator script
    outputDir = './storage/midi/generated'; // Output directory
    templatesDir = './storage/midi/templates'; // Template directory
